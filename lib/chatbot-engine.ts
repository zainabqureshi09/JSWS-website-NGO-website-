...
**Key Highlights:**
- 🏥 **15+ Years** of dedicated community welfare & healthcare service
- 👥 Over **100,000+** patients served across general OPD, specialty clinics & rehab
...
Patients can view and download their medical test reports online on our website at \`/laboratory\` by entering their **MR Number** and **Password** printed on their receipt.`
  },
  {
...
📝 **How to Apply:** You can fill out the online application form directly on our website at \`/scholarships\`.`
  },
  {
    id: "contact_location",
...
✉️ **Email Address:**
- \`jswswelfare@gmail.com\` / \`info@jsws.org.pk\`

🕒 **Working Hours:**
- General OPD & Admin: **Monday to Saturday** (10:00 AM to 6:30 PM)
- Sunday: Closed

⚠️ **Important Note:** JSWS provides Outpatient (OPD) and Rehabilitation services. **Emergency / 24/7 ER services are NOT available.**`
  },
  {
    id: "volunteer",
...
📝 You can fill out the Volunteer Application Form online on our website at \`/volunteer\`.`
  }
];
...
export function generateInternalChatResponse(userQuery: string): string {
  ...
  if (!normalized || normalized.length < 2) {
    return `Hello! Welcome to **Jamila Sultan Welfare Society (JSWS)**. 

How can I help you today? You can ask me about:
- 💳 **Donations & Bank Details**
- 👨‍⚕️ **Doctors & OPD Schedule**
...
- 📍 **Location, Address & Contact Numbers**`;
  ...
  if (isGreetingOnly && normalized.split(" ").length <= 3 && !normalized.includes("doctor") && !normalized.includes("donate")) {
    return `Wa Alaikum Assalam & Welcome to **Jamila Sultan Welfare Society (JSWS)**! 🌟
...
5. **Contact & Address** (Sector 31A Korangi Karachi)`;
  ...
  return `Thank you for reaching out to **Jamila Sultan Welfare Society (JSWS)**!
...
- 👨‍⚕️ **Doctors**: Available Mon-Sat (call **+92 307 2021882** for appointments).
- 🔬 **Lab Reports**: Subsidized diagnostic tests & online report download at \`/laboratory\`.
